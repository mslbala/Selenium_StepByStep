...
public class HandlingMultiSelectDropdowns {
    ...
    public void setUp() {
        ...
        driver.get("//F://Selenium_July//Day 2/MultiSelect.html");
    }

    public void handleMutliSelectDropdowns() throws InterruptedException {
        ...
        Thread.sleep(5000);
        selectObject.selectByValue("Safari");
...
//        selectObject.deselectAll();
    ...
    public static void main(String[] args) throws InterruptedException {
        HandlingMultiSelectDropdowns handleAlertsObject = new HandlingMultiSelectDropdowns();
        handleAlertsObject.setUp();
        handleAlertsObject.handleMutliSelectDropdowns();
